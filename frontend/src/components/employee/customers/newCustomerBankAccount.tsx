"use client";
import { useCreateAccountMutation } from "@/redux/queries/accounts/accountsApi";
      ...
      <div className="w-full bg-white rounded-xl shadow-md p-6 mx-auto">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-sm text-gray-500">
            Set up a bank account to start using your money
          </p>
...
export default NewCustomerBankAccount;
