"use client";
import { useRegisterEmployeeMutation } from "@/redux/queries/auth/authApi";
...
const NewEmployeeAccount = () => {
  const [register, { isLoading }] = useRegisterEmployeeMutation();
...
export default NewEmployeeAccount;
