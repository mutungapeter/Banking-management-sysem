"use client";
import { useGetAccountsQuery, useWithdrawMutation } from "@/redux/queries/accounts/accountsApi";
...
const Withdraw = () => {
  ...
  const handleWithdraw = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const successMessage = response.message || "Withdrawal successful!";
      ...
      <div className="w-full bg-white rounded-xl shadow-md p-6 mx-auto">
        <div className="flex flex-col items-center justify-center">
          <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mb-4">
            <LuCircleMinus className="h-8 w-8 text-red-500" />
          </div>
